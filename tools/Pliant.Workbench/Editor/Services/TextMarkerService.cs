...
namespace Pliant.Workbench.Editor.Services
{
    /// <summary>
    ...
    public sealed class TextMarkerService : DocumentColorizingTransformer, IBackgroundRenderer, ITextMarkerService, ITextViewConnect
    {
        ...
        public ITextMarker Create(int line, int col, int length)
        {
            var offset = document.GetOffset(new TextLocation(line, col));

            int textLength = document.TextLength;
            if (offset + length > textLength)
                return NullMarker.Instance;

            return Create(offset, length);
        }
    ...
    {
        public static ITextMarker MarkerColor(this ITextMarker marker, Color color)
        {
            marker.MarkerColor = color;
            return marker;
        }

        public static ITextMarker Type(this ITextMarker marker, TextMarkerTypes type)
        {
            marker.MarkerTypes = type;
            return marker;
        }

        public static ITextMarker ForegroundColor(this ITextMarker marker, Color color)
        {
    ...
    public class NullMarker : ITextMarker
    {
        public static readonly NullMarker Instance = new NullMarker();
    ...
    public interface ITextMarkerService
    {
        ...
        /// you need to set one of the Color properties to make it visible.
        /// </summary>
        ITextMarker Create(int line, int col, int length);
